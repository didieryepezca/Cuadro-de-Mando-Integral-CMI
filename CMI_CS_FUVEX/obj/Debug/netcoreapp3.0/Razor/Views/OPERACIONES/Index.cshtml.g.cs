#pragma checksum "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1d40b3f0c6bf88c63513497f6a20b075ea949989"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1d40b3f0c6bf88c63513497f6a20b075ea949989", @"/Views/OPERACIONES/Index.cshtml")]
...
#nullable disable
    ...
    window.onload = load;
     ...
     function funOperaciones(nombre) {
        ...
        $('#tbTotalesGifole').remove();

        $('#tbDesgloseGifole').remove();

        $('#tbAnualGifole').remove();
        $('#tbAnualFlashReportGifole').remove();
         //--------------------------------------------------------------------------------------- TABLA
         var url = ""/OPERACIONES/FunListarOperaciones"";
         $.get(url, { nombre: nombre, tipo: '");
#nullable restore
#line 87 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                        Write(ViewBag.tipo);
...
#nullable disable
         ...
         cabeceratotal = cabeceratotal + '</tr></thead>';
                 ...
                 data2.forEach(function (element2) {
                     ...
                     cabeceratotal = cabeceratotal + '<tr>';
                     //cabecera = cabecera + '<td> <small style=""color: blue"">' + element2.codigo + '</small></td>';
                     cabeceratotal = cabeceratotal + '<td> <small style=""color: green"">' + element2.total.toLocaleString('en') + '</small> </td>';
         ...
         $.get(url, { nombre: nombre, tipo: '");
#nullable restore
#line 224 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                        Write(ViewBag.tipo);
...
#nullable disable
         ...
         $.get(url, { nombre: nombre, tipo: '");
#nullable restore
#line 265 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                        Write(ViewBag.tipo);
...
#nullable restore
#line 413 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                         Write(ViewBag.tipo);
...
#nullable disable
        ...
        //-------------------------------------------------------------");
            WriteLiteral("-------------------------- TABLA ANUAL\r\n         var url = \"/OPERACIONES/FunListarOperacionesAnual\";\r\n         $.get(url, { nombre: producto, tipo: \'");
#nullable restore
#line 443 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                          Write(ViewBag.tipo);
...
#nullable disable
            ...
            tablaAnual = tablaAnual + '</tr></thead>';
             ...
             dat");
            WriteLiteral(@"a3.forEach(function (element4) {
            ...
            WriteLiteral(@"tablaAnual + '<td> <small style=""color: blue"">' + element4.julio.toLocaleString('en') + '</small> </td>';
                ...
                tablaAnual = tablaAnual + '<td> <small style=""color: green"">' + eleme");
            WriteLiteral(@"nt4.promedio.toLocaleString('en') + '</small> </td>';
    ...
    function funOperacionesGifole(producto) {
        ...
        //--------------------------------------------------------------------------------------- TABLA
         var url = ""/OPERACIONES/FunListarOperacionesGifole"";
         $.get(url, { nombre: producto, tipo: '");
#nullable restore
#line 514 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                          Write(ViewBag.tipo);
...
#nullable disable
            ...
            $('#pnlDiarioGifole').append('<table class=""table table-hover m-b-0"" style=""font-size:12.5px;"" id=""tbDiarioGifole"" >' + cabecera + '</table>').fadeIn(300000);
            //----------------------------------------------------------------------------
         ...
         cabeceratotal = '<thead >';
 ");
            WriteLiteral(@"        cabeceratotal = cabeceratotal + '<tr>';
         //cabeceratotal = cabeceratotal + '<th>.</th>';
         cabeceratotal = cabeceratotal + '<th>.</th>';
         cabeceratotal = cabeceratotal + '</tr></thead>';
         ...
         cabeceratotal = cabeceratotal + '</tr></thead>';
                 ...
                 data2.forEach(function (element2) {
                     ...
                     cabeceratotal = cabeceratotal + '<td> <small style=""color: green"">' + element2.total.toLocaleString('en') + '</small> </td>';
                     cabecerat");
            WriteLiteral(@"otal = cabeceratotal + '</tr>';

                     //console.log(cabecera);

                 });
             $('#pnlDiarioTotalGifole').append('<table class=""table table-hover m-b-0"" style=""font-size:12.5px;"" id=""tbTotalesGifole"" >' + cabeceratotal + '</table>').fadeIn(300000);

         });


           //--------------------------------------------------------------------------------------- TABLA DESGLOSE GIFOLE
         var url = ""/OPERACIONES/FunListarOperacionesDesgloseGifole"";
         $.get(url, { nombre: producto, tipo: '");
#nullable restore
#line 652 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                          Write(ViewBag.tipo);
...
#nullable disable
            ...
            $('#pnlDesgloseGifole').append('<table class=""table table-hover m-b-0"" style=""font-size:12.5px;"" id=""tbDesgloseGifole"" >' + cabecera + '</table>').fadeIn(300000);

          });


        //--------------------------------------------------------------------------------------- TABLA ANUAL GIFOLE
        var url = ""/OPERACIONES/FunListarOperacionesAnualGifole"";
        $.get(url, { nombre: producto, tipo: '");
#nullable restore
#line 692 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                         Write(ViewBag.tipo);
...
#nullable disable
            ...
            $('#pnlAnualGifole').append('<table class=""table table-hover m-b-0"" style=""font-size:12.5px;"" id=""tbAnualGifole"" >' + cabeceraAnual + '</table>').fadeIn(300000);
        })


        //-------------------------------------------------------");
            WriteLiteral("-------------------------------- TABLA ANUAL GIFOLE\r\n         var url = \"/OPERACIONES/FunListarOperacionesAnualGifole\";\r\n         $.get(url, { nombre: producto, tipo: \'");
#nullable restore
#line 719 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                          Write(ViewBag.tipo);
...
#nullable disable
            ...
            $('#pnlAnualMesesGifole').append('<table class=""table table-hover m-b-0"" style=""font-size:12.5px;"" id=""tbAnualFlashReportGifole"" >' + tablaAnual + '</table>').fadeIn(300000);
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1d40b3f0c6bf88c63513497f6a20b075ea94998942540", async() => {
                WriteLiteral(@"
        ...
        <div class=""row clearfix"">
            ...
            <div class=""col-lg-9 col-md-9 col-3"">
                ...
                <ul class=""nav nav-tabs"">
                    ...
                    <li class=""nav-item""><a class=""nav-link"" data-toggle=""tab"" onclick=""funOperaciones('TARJETA DE CREDITO');funOperacionesAnual('TARJETA DE CREDITO');funOperacionesGifole('TARJETA DE CREDITO')"" style=""cursor:pointer"" aria-expanded=""false"">TARJETA DE CREDITO</a></li>
...
#nullable restore
#line 818 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                     Write(ViewBag.YEAR);
...
#nullable disable
                WriteLiteral("</h5>\r\n                        <small>Año</small>\r\n                    </div>\r\n                    <div class=\"col-4\">\r\n                        <h5 class=\"m-b-5\">");
#nullable restore
#line 822 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                     Write(ViewBag.MES);
...
#nullable restore
#line 826 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                     Write(ViewBag.DAY);
...
#nullable restore
#line 846 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                                                    Write(ViewBag.MES);
...
#nullable restore
#line 895 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                                                                                                       Write(ViewBag.MES);
...
#nullable restore
#line 923 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                                                                   Write(ViewBag.MES);
...
#nullable restore
#line 941 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                                                      Write(ViewBag.YEAR);
...
#nullable disable
                ...
                WriteLiteral(@"iv class=""col-md-3"">
                            <div class=""card parents-list"">
                                <div class=""header"">
                                    <h2><strong>Flash Report Gifole</strong></h2>
                                </div>
                ...
                WriteLiteral(@"       </div>
                        ...
                        <div class=""col-md-2"">
                            <div class=""card parents-list"">
                                ...
                                <div class=""body"">
                                    <div class=""table-responsive"" id=""pnlDiarioTotalGifole"">
                    ...
                    <div class=""row clearfix"">
                        ...
                        <div class=""col-md-12"">
                            <div class=""card parents-list"">
                                <div class=""header"">
                                    <h2><strong>Gifole</strong> Desglose de");
                WriteLiteral(@" Operaciones</h2>

                                </div>
                                <div class=""body"">
                                    <div class=""table-responsive"" id=""pnlDesgloseGifole"">
                        ...
                        <div class=""col-md-3"">
                            <div class=""card parents-list"">
                                <div class=""header"">
                                    <h2><strong>Flash Report</strong> Año: ");
#nullable restore
#line 1041 "C:\Workspace\CMI_CS_FUVEX\CMI_CS_FUVEX\Views\OPERACIONES\Index.cshtml"
                                                                      Write(ViewBag.YEAR);
...
#nullable disable
                WriteLiteral(@"</h2>
                                ...
                                <div class=""body"">
                                    <div class=""table-responsive"" id=""pnlAnualGifole"">
                        ...
                        <div class=""col-md-9"">
                            <div class=""card parents-list"">
                                <div class=""header"">
                                    <h2><strong>Gifole Resumen Anual</strong></h2>

                                </div>
                                <div class=""body"">
                                    <div class=""table-responsive"" id=""pnlAnualMesesGifole"">
